...
/* buildSolverFreqs (ranges préflop heuristiques) déplacé dans
   src/solver/preflopRanges.js — importé en tête (source unique). */
...
/* VILLAIN_ACTION_MAP + buildVillainResponseFreqs déplacés dans src/solver/preflopRanges.js
   (importés en tête). */
